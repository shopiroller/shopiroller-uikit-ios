...
class SRAddressBottomSheetViewModel : SRBaseViewModel {
    ...
    func getSelectionModel() -> SRSelectionViewModel {
        ...
        case .district:
            return SRSelectionViewModel(selectionPopUpModel: SelectionModel(datalist: getDistricts(), selectionType: .adress(.district)))
        case .state:
