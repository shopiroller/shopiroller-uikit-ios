...
open class SROrderListViewController: BaseViewController<SROrderListViewModel>, EmptyViewDelegate {
    
    @IBOutlet private weak var emptyView: EmptyView!
    @IBOutlet private weak var orderTable: UITableView!
    
    public init(viewModel: SROrderListViewModel) {
        super.init("e_commerce_my_orders_title".localized, viewModel: viewModel, nibName: SROrderListViewController.nibName, bundle: Bundle(for: SROrderListViewController.self))
    }
    ...
    private func getOrderDetail() {
        let viewController = SROrderDetailViewController(viewModel: SROrderDetailViewModel(detail: self.viewModel.getOrderDetailModel()))
...
extension SROrderListViewController: UITableViewDelegate, UITableViewDataSource {
