...
class SRShoppingCartViewController: BaseViewController<SRShoppingCartViewModel>, EmptyViewDelegate {
    ...
    private func showCouponErrorDialog(error: String) {
        let popupVC = PopUpViewViewController(viewModel: PopUpViewModel(image: .outOfStock, title: "e_commerce_shopping_cart_coupon_dialog_title".localized, description: error , firstButton: PopUpButtonModel(title: "e_commerce_shopping_cart_back_to_cart".localized, type: .lightButton), secondButton: nil))
