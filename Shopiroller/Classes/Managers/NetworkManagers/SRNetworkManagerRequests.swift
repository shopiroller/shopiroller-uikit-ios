...
struct SRNetworkManagerRequests {
    ...
    static func getProductsWithAdvancedFiltered(urlQueryItems: [URLQueryItem] = []) -> SRNetworkRequestManager<[ProductListModel]> {
        return SRNetworkRequestManager(
            httpMethod: .get,
            path: .getProductsWithAdvancedFiltered,
            resourceType: [ProductListModel].self,
    ...
    static func getProducts(showProgress: Bool,urlQueryItems: [URLQueryItem] = []) -> SRNetworkRequestManager<[ProductDetailResponseModel]> {
        return SRNetworkRequestManager(
            httpMethod: .get,
            path: .getProducts,
            resourceType: [ProductDetailResponseModel].self,
            urlQueryItems: urlQueryItems,
    ...
    static func makeOrder(_ makeOrder: SRMakeOrderResponse,userId: String,showProgress: Bool? = nil) -> SRNetworkRequestManager<SROrderResponseInnerModel> {
        return SRNetworkRequestManager(
            ...
            path: .makeOrder,
            subpath: "/\(userId)",
            resourceType: SROrderResponseInnerModel.self,
            httpBody: makeOrder.data,
            shouldShowProgressHUD: showProgress ?? true)
    }
    ...
    static func getShoppingCart(userId: String,showProgress: Bool? = nil) -> SRNetworkRequestManager<SRShoppingCartResponseModel> {
        ...
        return SRNetworkRequestManager(
            ...
            path: .users,
            subpath: subPath,
            resourceType: SRShoppingCartResponseModel.self,
            shouldShowProgressHUD: showProgress ?? true)
    }
    ...
    static func removeItemFromShoppingCart(userId: String, cartItemId: String) -> SRNetworkRequestManager<SuccessResponse> {
        ...
        return SRNetworkRequestManager(
            ...
            path: .users,
            subpath: subpath,
            resourceType: SuccessResponse.self,
            ignoreParse: true)
    }
    ...
    SRNetworkRequestManager<SRAddToCardResponse> {
        ...
        return SRNetworkRequestManager(
            ...
            path: .users,
            subpath: subpath,
            resourceType: SRAddToCardResponse.self,
    ...
    SRNetworkRequestManager<SuccessResponse> {
        ...
        return SRNetworkRequestManager(
            ...
            subpath: subpath,
            resourceType: SuccessResponse.self,
            httpBody: userBillingAddress.data,
            ignoreParse: true,
            isUser: true)
    }
    ...
    SRNetworkRequestManager<SuccessResponse> {
        ...
        return SRNetworkRequestManager(
            ...
            subpath: subpath,
            resourceType: SuccessResponse.self,
            httpBody: userShippingAddress.data,
            ignoreParse: true,
            isUser: true)
    }
    ...
    static func failurePayment(stripeOrderModel: SRStripeOrderStatusModel?) -> SRNetworkRequestManager<SuccessResponse> {
        return SRNetworkRequestManager(
            ...
            path: .failurePayment,
            resourceType: SuccessResponse.self,
            httpBody: stripeOrderModel.data)
    }
    ...
    static func getSliders(showProgress: Bool) -> SRNetworkRequestManager<[SRSliderDataModel]> {
        return SRNetworkRequestManager(
            httpMethod: .get,
            path: .getSliders,
            resourceType: [SRSliderDataModel].self,
            shouldShowProgressHUD: showProgress)
    }
    ...
    static func getSubCategories(categoryId: String) -> SRNetworkRequestManager<SRCategoryResponseModel> {
        return SRNetworkRequestManager(
            ...
            resourceType: SRCategoryResponseModel.self)
    }
    ...
    static func getShowCase(showProgress: Bool) -> SRNetworkRequestManager<[SRShowcaseResponseModel]> {
        return SRNetworkRequestManager(
            httpMethod: .get,
            path: .getShowcase,
            resourceType: [SRShowcaseResponseModel].self,
            shouldShowProgressHUD: showProgress)
    }
    ...
    static func getFilterOptions(urlQueryItems: [URLQueryItem] = []) -> SRNetworkRequestManager<SRFilterOptionsResponseModel> {
        return SRNetworkRequestManager(
            httpMethod: .get,
            path: .getFilterOptions,
            resourceType: SRFilterOptionsResponseModel.self,
            urlQueryItems: urlQueryItems)
    }
    ...
    static func getShippingAddresses(userId: String) -> SRNetworkRequestManager<[UserShippingAddressModel]> {
        ...
        return SRNetworkRequestManager(
            ...
            path: .addresses,
            subpath: subpath,
            resourceType: [UserShippingAddressModel].self,
            ignoreBaseModel: true,
            isUser: true)
    }
    ...
    static func getBillingAddresses(userId: String) -> SRNetworkRequestManager<[UserBillingAdressModel]> {
        ...
        return SRNetworkRequestManager(
            ...
            path: .addresses,
            subpath: subpath,
            resourceType: [UserBillingAdressModel].self,
            ignoreBaseModel: true,
            isUser: true)
    }
    ...
    static func getDefaultAddress(userId: String) -> SRNetworkRequestManager<SRDefaultAddressModel> {
        ...
        return SRNetworkRequestManager(
            ...
            path: .addresses,
            subpath: subpath,
            resourceType: SRDefaultAddressModel.self,
            shouldShowProgressHUD: true,
            ignoreBaseModel: true,
            isUser: true)
    }
    ...
    static func getCountryList() -> SRNetworkRequestManager<[CountryModel]> {
        ...
        return SRNetworkRequestManager(
            ...
            path: .addresses,
            subpath: subpath,
            resourceType: [CountryModel].self,
            shouldShowProgressHUD: true,
            ignoreBaseModel: true,
            isUser: true)
    }
    ...
    static func getClient() -> SRNetworkRequestManager<[ClientResponseModel]> {
        return SRNetworkRequestManager(
            httpMethod: .get,
            path: .client,
            resourceType: [ClientResponseModel].self,
            shouldShowProgressHUD: false)
    }
}
